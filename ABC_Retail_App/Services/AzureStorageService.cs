    ...
    public class AzureStorageService : IAzureStorageService
    {
        ...
        private async Task InitializeStorageAsync()
        {
            try
            {
                ...
                // Create payments directory in contacts share
            ...
            catch (Exception ex)
            {
                ...
                throw; //Re-trow to make the error visible
            }
        }
        ...
        public async Task<List<T>> GetAllEntitiesAsync<T>() where T : class, ITableEntity, new()
        {
            ...
            var tableClient = _tableServiceClient.GetTableClient(typeof(T).Name + "s");
        ...
        public async Task<T?> GetEntityAsync<T>(string partitionKey, string rowKey) where T : class, ITableEntity, new()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Error fetching entity {rowKey} from {tableName}: {ex.Message}", ex);
            }
        }
        ...
        public async Task<string> UploadFileAsync(IFormFile file, string containerName)
        {
            ...
            {
                _logger.LogError(ex, "Error uploading file to share {ContainerName}: {Message}", containerName, ex.Message);
                throw;
            }
        }
        ...
        private static string GetTableName<T>() where T : class, ITableEntity
        {
